...
% ---- Title block ----------------------------------------------------
\begin{center}
  {\Huge\bfseries \placeholder{Your Project Name}}\\[6pt]
  {\Large\color{forgemute} Project proposal \& Statement of Work}\\[18pt]
  {\large \placeholder{PM's name}, Project Manager}\\[10pt]
  {\large \placeholder{List remaining team members here, one name per line,\\
   first name, last name, alphabetically by last name}}\\[12pt]
  {\large POTENTIAL ADVISORS: \placeholder{LIST POTENTIAL ADVISORS FOR YOUR GROUP HERE}}\\[14pt]
  {\large Date: \placeholder{Month, Day, Year}}
\end{center}
